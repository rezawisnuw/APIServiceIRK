...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'pgsqlgcp_irk' =>[
            'driver' => 'pgsql',
            'host' => env('DB_HOST_PGSQLGCP_IRK', 'dbirk'),
        ...
        'pgsqlgcp_irk_stag' =>[
            ...
            'username' => env('DB_USERNAME_PGSQLGCP_IRK_STAG', 'postgres'),
            'password' => env('DB_PASSWORD_PGSQLGCP_IRK_STAG', 'admin'),
            'charset' => 'utf8',
            'prefix' => '',
            'schema' => 'public',
            'sslmode' => 'prefer',
        ...
        'pgsqlgcp_irk_dev' =>[
            ...
            'username' => env('DB_USERNAME_PGSQLGCP_IRK_DEV', 'postgres'),
            'password' => env('DB_PASSWORD_PGSQLGCP_IRK_DEV', 'admin'),
            'charset' => 'utf8',
            'prefix' => '',
            'schema' => 'public',
            'sslmode' => 'prefer',
