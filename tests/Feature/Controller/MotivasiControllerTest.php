...
use App\Http\Controllers\Dev\IRK\MotivasiController;

class MotivasiControllerTest extends TestCase
{
    use RefreshDatabase;

    public function testGetEndToEndSuccess()
    {
        $response = $this->post('/api/dev/motivasi/get', [
            'userid' => 1,
            'code' => '2'
        ]);
    ...
    {
        $gatewayMock = $this->getMockBuilder(MotivasiController::class)
