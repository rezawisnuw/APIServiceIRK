...
use App\Http\Controllers\Dev\IRK\CeritakitaController;

class CeritaKitaControllerTest extends TestCase
{
    use RefreshDatabase;

    public function testGetEndToEndSuccess()
    {
        $response = $this->post('/api/dev/ceritakita/get', [
            'userid' => 1,
            'code' => '2'
        ]);
    ...
    {
        $gatewayMock = $this->getMockBuilder(CeritakitaController::class)
