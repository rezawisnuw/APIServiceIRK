...
use App\Http\Controllers\Dev\IRK\CurhatkuController;

class CurhatkuControllerTest extends TestCase
{
    use RefreshDatabase;

    public function testGetEndToEndSuccess()
    {
        $response = $this->post('/api/dev/curhatku/get', [
            'userid' => 1,
            'code' => '2'
        ]);
    ...
    {
        $gatewayMock = $this->getMockBuilder(CurhatkuController::class)
