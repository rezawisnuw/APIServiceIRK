...
use App\Models\IRK_v3\BookmarkModel;
...
class BookmarkController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $model = new BookmarkModel($request, $slug);
        $this->model = $model;
    ...
    public function get(Request $request)
    {
        ...
        try {
            $result = $this->model->showDataBookmark($data);
        } catch (\Throwable $e) {
            $result = collect([
                'status' => 'Error',
                'data' => null,
    ...
    public function post(Request $request)
    {
        ...
        try {
            $result = $this->model->inputDataBookmark($data);
        } catch (\Throwable $e) {
            $result = collect([
                'status' => 'Error',
                'data' => null,
    ...
    public function put(Request $request)
    {
        ...
        try {
            $result = $this->model->editDataBookmark($data);
        } catch (\Throwable $e) {
            $result = collect([
                'status' => 'Error',
                'data' => null,
