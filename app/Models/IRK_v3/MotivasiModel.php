...
class MotivasiModel extends Model
{
    ...
    public function showDataMotivasi($request)
    {
        ...
        try {
            $data = [];
            $data = $this->connection->select("select * from public_v3.showmotivasilist(?,?)", [$userid, $page]);
    ...
    public function showDataMotivasiSingle($request)
    {
        ...
        try {
            $data = [];
            $data = $this->connection->select("select * from public_v3.showmotivasidetail(?,?)", [$userid, $idticket]);
