...
class CurhatkuModel extends Model
{
    ...
    public function showDataCurhatku($request)
    {
        ...
        try {
            $data = [];
            $data = $this->connection->select("select * from public_v3.showcurhatkulist(?,?)", [$userid, $page]);
    ...
    public function showDataCurhatkuSingle($request)
    {
        ...
        try {
            $data = [];
            $data = $this->connection->select("select * from public_v3.showcurhatkudetail(?,?)", [$userid, $idticket]);
