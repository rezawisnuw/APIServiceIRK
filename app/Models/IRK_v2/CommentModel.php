...
class CommentModel extends Model
{
    ...
    public function showDataNewComment($request)
    {
        ...
        try {
            $data = [];
            $data = $this->connection->select("select * from public_v2.shownewcomment(?,?,?)", [$idticket, $parentreply, $userid]);
    ...
    public function inputDataNewComment($request)
    {
        ...
        try {
            ...
            $data = $this->connection->insert("CALL public_v2.inputnewcomment(?,?,?,?,?,?,?)", [$nik, $comment, $idticket, $alias, $tag, $parentreply, $platform]);
    ...
    public function editDataNewComment($request)
    {
        ...
        try {
            $data = $this->connection->insert("CALL public_v2.editnewcomment(?,?,?,?)", [$userid, $nik, $parentreply, $idticket]);
    ...
    public function editDataReplyNewComment($request)
    {
        ...
        try {
            $data = $this->connection->insert("CALL public_v2.editreplynewcomment(?,?,?,?)", [$userid, $nik, $idcomment, $parentreply]);
