...
class CurhatkuModel extends Model
{
    ...
    public static function showDataCurhatku($request)
    {
        ...
        try
        {
            ...
            $data = DB::connection(config('app.URL_PGSQLGCP_IRK'))->select("select * from showcurhatkulist(?,?)",[$userid,$page]);
    ...
    public static function showDataCurhatkuSingle($request)
    {
        ...
        try
        {
            $data = DB::connection(config('app.URL_PGSQLGCP_IRK'))->select("select * from showcurhatkudetail(?,?)",[$userid,$idticket]);
