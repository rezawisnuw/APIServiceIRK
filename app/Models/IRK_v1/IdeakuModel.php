...
class IdeakuModel extends Model
{
    ...
    public function showDataIdeaku($request)
    {
        ...
        try {
            $data = $this->connection->select("select * from public.showideakulist(?,?)", [$userid, $page]);
    ...
    public function showDataIdeakuSingle($request)
    {
        ...
        try {
            $data = $this->connection->select("select * from public.showideakudetail(?,?)", [$userid, $idticket]);
