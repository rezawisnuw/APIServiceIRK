...
class MotivasiModel extends Model
{
    ...
    public function showDataMotivasi($request)
    {
        ...
        try {
            $data = $this->connection->select("select * from public.showmotivasilist(?,?)", [$userid, $page]);
    ...
    public function showDataMotivasiSingle($request)
    {
        ...
        try {
            $data = $this->connection->select("select * from public.showmotivasidetail(?,?)", [$userid, $idticket]);
