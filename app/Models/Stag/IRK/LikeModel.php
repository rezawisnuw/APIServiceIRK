...
class LikeModel extends Model
{
    ...
    public static function showDataLikeTotal($request)
    {
        ...
        try
        {
            ...
            $data = DB::connection(config('app.URL_PGSQLGCP_IRK_STAG'))->select("select * from showlike(?,?)",[$idticket,$tag]);
    ...
    public static function inputDataLike($request)
    {
        ...
        try
        {
            $data = DB::connection(config('app.URL_PGSQLGCP_IRK_STAG'))->insert("CALL inputlike(?,?,?,?,?)", [$nik,$idticket,$tag,$alias,$userlike]);
